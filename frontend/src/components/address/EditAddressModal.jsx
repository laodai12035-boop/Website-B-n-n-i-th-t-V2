...
/**
 * EditAddressModal — Modal Chỉnh sửa địa chỉ giao hàng.
...
const EditAddressModal = ({ isOpen, onClose, addressItem, onSuccess }) => {
  ...
  // Tự động định vị vị trí GPS người dùng
      ...
      <div className="relative w-full max-w-lg bg-white rounded-none shadow-2xl border border-stone-200/80 overflow-hidden animate-slide-up">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4 text-xs">
          ...
          <div className="pt-2 flex items-center gap-2">
            ...
            />
            <label htmlFor="edit_is_default" className="text-xs font-bold text-stone-700 cursor-pointer uppercase tracking-wider">
